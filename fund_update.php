...
exit();
	...
	$old_amount=$_POST['amount'];
			...
			{ $old_amount= $row['Fund_donated'];}}
			
			
            mysqli_select_db( $conn,'test_db');
            $sql2 = "UPDATE users set Fund_donated=$old_amount+$amount where user_id='$User'; ";
...
<html>
	...
	<h1 style="padding:400px 80px; color: white"> Thank you! Your Donation has been Submitted <h1>
